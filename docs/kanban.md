...
- Individuell rapport, Henrik (Henrik)
- Individuell rapport, Tarik (Tarik)
- Individuell rapport, Salah (Salah)
- Individuell rapport, Alan (Alan)
- Långtidstest: låta pipelinen rulla ett helt dygn och se att inget hänger sig (Henrik)
- Bjuda in läraren till vårt GitHub Project (Henrik)

## In progress

- Ta skärmbilder till README:n: kopplingen, Wokwi och Grafana (Alan)
- Presentationsbilder till slutdemon (Tarik, Salah)
...
- DHT11:an svarar inte varje gång, fixat med try/except (Tarik)
- Consumern startade före databasen, fixat med väntetid och restart (Salah)
- Loggarna syntes inte i docker logs, fixat med PYTHONUNBUFFERED (Salah)
...
- Mall för den individuella rapporten (Henrik)
- Checklista för GitHub och inlämning (Tarik)
